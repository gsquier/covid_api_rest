...
print("The output is expected to be a JSON.")
...
print("The output is expected to be: The country is not listed")
...
print("The output is expected to be: Specify country")
